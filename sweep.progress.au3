#cs ----------------------------------------------------------------------------
 ...
 Script Function:
    Show progress meters for a batch process
	Based on runLORASR.Progress v0.4.4.0
...
Func DrawProgressWindow()
    ...
    $hProgressWindow = GUICreate("sweep progress", $iProgressWindowWidth, $iProgressWindowHeight, $iProgressWindowXPosition, $iProgressWindowYPosition, $WS_CAPTION & $WS_POPUP)
...
Func UpdateProgress($sProgressType, $iProgressPercentage, $sLabel = "")
    ...
    Switch $sProgressType
        ...
        Case "both"
            ; First call the function again for the overall bar
            UpdateProgress("overall", $iProgressPercentage, "")
            ; Then continue as if called for the current bar
            $hProgressBar = $g_hCurrentProgressBar
            $hProgressLabel = $g_hCurrentProgressDetailLabel
    EndSwitch
